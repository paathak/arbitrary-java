...
public class Main
{
	...
	//if compiler mandatorily gives compile error then what in case if it was runtime Exception , compiler just took side of unchecked here!! (obviously because to support existing code before generics that might not have handled an unchecked exception, one that would have handled has no impact in this case)
